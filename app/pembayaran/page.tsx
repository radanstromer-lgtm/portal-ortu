...
export default async function PembayaranPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="min-h-screen bg-gray-100 flex justify-center">
      {/* Popup Welcome jika datang dari instant link */}
      {isWelcomeFlow && (
        <WelcomeModal
      ...
      <div className="w-full max-w-md bg-white min-h-screen shadow-lg relative pb-20">
        ...
        <header className="bg-gradient-to-r from-emerald-700 to-teal-700 text-white p-5 sticky top-0 z-10 rounded-b-xl shadow-md">
          ...
          <div className="mt-3 pt-3 border-t border-emerald-500/30">
            <p className="text-sm text-emerald-100">
              💳 Informasi SPP & Tagihan <span className="font-semibold text-white">{session.nama}</span>
            </p>
          </div>
        </header>
        ...
        <div className="p-4 mt-2">
          <h2 className="text-gray-800 font-semibold mb-4 text-lg">Daftar Transaksi SPP</h2>
