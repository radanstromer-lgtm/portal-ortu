...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  // Fetch data rincian raport siswa
  const { summary, groupedByMapel } = await getRaportSiswa(session.userId);
        ...
        <div className="p-4 space-y-4 mt-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-[11px] text-emerald-100/80 mt-0.5">Hasil & nilai belajar</p>
            </Link>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-gray-200/80 shadow-sm">
            <div className="flex justify-between items-center mb-3">
              ...
              <Link href="/pembayaran" className="text-xs text-blue-600 font-semibold hover:underline">
                Lihat Semua →
              </Link>
            </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-gray-200/80 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-2.5 text-center">
              <div className="p-3 bg-blue-50/60 border border-blue-100 rounded-xl">
                <p className="text-xl font-bold text-blue-700">{summary.persentaseSangatMenguasai}%</p>
                <p className="text-[11px] text-gray-500 mt-0.5">Sangat Menguasai</p>
              </div>
              <div className="p-3 bg-emerald-50/60 border border-emerald-100 rounded-xl">
                <p className="text-xl font-bold text-emerald-700">{groupedByMapel.length}</p>
